    ...
    <div class="menu_side">
        ...
        <div class="playlist">
            <h4 class="active"><span></span><i class="bi bi-music-note-beamed"></i> Playlist</h4>
             <a href="todaytop.jsp" style="text-decoration: none; color: inherit;">
            <h4 ><span></span><i class="bi bi-music-note-beamed"></i> Recommended</h4></a>
            <a href="search.jsp" style="text-decoration: none; color: inherit;">
            <h4><i class="bi-search" style="margin-right: 20px;"></i>Search</h4></a>
    ...
    <div class="song_side">
        <nav>
            <ul>
                ...
                <li><a href="jsonnn.jsp">Download</a></li>
                 <li><a href="news.jsp">IPL</a></li>
            </ul>

           
            <nav class="user">
                <div class="dropdown">
                  <img src="./img/user.jpg" alt="User Image" class="user-image" id="userDropdown">
